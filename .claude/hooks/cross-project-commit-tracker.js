...
// Known project mappings (customize for your setup)
...
const PROJECT_MAPPINGS = [
  // Example: Main projects hub
  {
    pathPattern: new RegExp(`^${HOME}/Projects`),
    name: 'Projects',
    github: 'my-projects',
    type: 'hub'
  },
  ...
  // Fallback: Any ~/Code/* project (extracts name from path)
  {
    pathPattern: new RegExp(`^${HOME}/Code/([^/]+)`),
...
/**
 * PostToolUse Hook - Track commits across projects
 */
module.exports = {
