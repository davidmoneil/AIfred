...
| `.claude/agents/*.md` | Listed in CLAUDE.md agents table |
| `.claude/hooks/*.js` | Documented in hooks/README.md |
| `.claude/skills/**` | Indexed in skills/_index.md |
| `docker/**` | Described in .claude/context/systems/docker/*.md |
...
3. Check hooks/README.md → "Hook count says 11, but there are 17"
