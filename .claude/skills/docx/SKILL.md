...
version: 1.0.0
category: document
tags: [word, docx, document, office, track-changes, comments, redlining]
token_cost: ~12500
when_to_use: |
  - User requests creating a Word document (.docx)
...
- Extracting or analyzing document content
- Working with redlining workflows

**Do NOT use when**:
- Simple text file output is sufficient (use Write tool)
- PDF output is required (use pdf skill)
- Presentation format needed (use pptx skill)

**Complements**: pdf (for final distribution), pptx (for presentations)
