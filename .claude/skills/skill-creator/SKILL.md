...
tags: [skill, create, workflow, knowledge, claude-code, extension]
token_cost: ~5100
when_to_use: |
  - User wants to create a new skill
  - User needs to update an existing skill
  - User asks about skill structure or best practices
  - User wants to package knowledge as a skill
  - User needs guidance on skill design patterns
dependencies: [Write, Read, Edit]
overlaps_with: [mcp-builder]
...
- Packaging domain knowledge into reusable form
- Designing skill workflows and structure
- Updating or improving existing skills

**Do NOT use when**:
- Building external tools (use mcp-builder instead)
- Creating MCP servers (use mcp-builder instead)
- Simple documentation (use docx or Write tool)
