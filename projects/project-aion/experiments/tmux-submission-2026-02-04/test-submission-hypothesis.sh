...
# Purpose: Test different ways of combining text + submission signal
#
# Hypotheses to test:
# A: Separate calls - text first, then C-m (what test script does)
# B: Combined literal - text + CR in single literal string
# C: Combined args - text as literal, C-m as key in same call
# D: Single call with appended CR in variable
#
