...
# Purpose: Determine which tmux send-keys method successfully submits prompts to Claude Code
#
# Usage: Run this script while Claude Code is at an idle prompt in the jarvis tmux session
# The script will test each method and ask you to verify if it worked
#
