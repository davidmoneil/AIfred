...
#
# Cron: 0 3 * * 0 ${AIFRED_HOME:-$HOME}/scripts/weekly-docker-restart.sh
#
# Created: 2025-12-27
...
COMPOSE_STACKS=(
    "${DOCKER_ROOT:-$HOME/docker}/n8n"
    "${DOCKER_ROOT:-$HOME/docker}/logging"
    "${DOCKER_ROOT:-$HOME/docker}/mcp"
    "${DOCKER_ROOT:-$HOME/docker}/caddy"
)
